...
generate-favorite-service-api:
	mkdir -p pkg
	mkdir -p pkg/favorite-service
	protoc --proto_path api --proto_path vendor.protogen \
	--go_out=pkg/favorite-service --go_opt=paths=source_relative \
	--plugin=protoc-gen-go=bin/protoc-gen-go \
	--go-grpc_out=pkg/favorite-service --go-grpc_opt=paths=source_relative \
	--plugin=protoc-gen-go-grpc=bin/protoc-gen-go-grpc \
	--validate_out lang=go:pkg/favorite-service --validate_opt=paths=source_relative \
	--plugin=protoc-gen-validate=bin/protoc-gen-validate \
	--grpc-gateway_out=pkg/favorite-service --grpc-gateway_opt=paths=source_relative \
...
generate:
	mkdir -p pkg/swagger
	make generate-favorite-service-api
