...
func (a *App) initGRPCServer(ctx context.Context) error {
	...
	desc.RegisterFavoriteServiceServer(a.grpcServer, a.serviceProvider.FavoriteImpl(ctx))
...
func (a *App) initHTTPServer(ctx context.Context) error {
	...
	err := desc.RegisterFavoriteServiceHandlerFromEndpoint(ctx, mux, a.serviceProvider.GRPCConfig().Address(), opts)
	if err != nil {
		return err
	}
